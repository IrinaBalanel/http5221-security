...
//Output messages
    ...
    var outOfRange = "Way off!!!! Pick between 1 and 10.";//IB, May 30: added !!!! according to specs
...
//Validate input and assign a return message
    ...
    } else if (guess < 1 || guess > 10) { //IB, May 30: changed <= and => to < and > because according to the specifications, the out-of-range should't include 1 and 10
